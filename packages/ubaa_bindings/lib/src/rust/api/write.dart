...
// These functions are ignored because they are not marked as `pub`: `cgyy_canonical`, `digest_bytes`, `digest`, `ensure_bykc_select_allowed`, `ensure_bykc_select_target`, `feature`, `invalid_input`, `map_cgyy_request`, `map_evaluation_course`, `map_resolution_error`, `now_seconds`, `operation`, `prepare_write`, `random_id`, `safe_message`, `store_write_intent`, `text_shape`, `validate_cgyy_request`, `validate_id_i32`, `validate_id`, `validate_text`, `validate_ygdk_request`, `ygdk_canonical`
