...
// These functions are ignored because they are not marked as `pub`: `digest_bytes`, `digest`, `feature`, `invalid_input`, `map_cgyy_request`, `map_evaluation_course`, `map_resolution_error`, `now_seconds`, `operation`, `prepare_write`, `random_id`, `safe_message`, `validate_id_i32`, `validate_id`, `validate_text`
