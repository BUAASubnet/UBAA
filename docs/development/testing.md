...
| Shell contract | `scripts/test-verify-live.sh` | Synthetic JSON-captcha to human fallback, fresh-human no-captcha completion, non-interactive failure, and suppression of human profile output |
