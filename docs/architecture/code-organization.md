...
状态：2026-09-05 目录与职责设计及阶段 14A/14B 修复已实现；新候选按第 10.4 节重新绑定完整验收
...
最终源码范围有 494 个手写文件、107026 行、135 个直属源码目录；排除 21 个 Cargokit 文件和 8 个 FRB
...
候选 CI 的失败必须先按实施计划阶段 14A/14B 修复并形成新提交，再从本节第一条命令完整重验；即使旧候选的
