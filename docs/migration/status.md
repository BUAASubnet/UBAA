...
## 当前活动阶段：P4-B2 已复验，接续 P4-A 剩余资料与设置
...
B1已提交 `83ee9e89`；B2学期/日期/typed楼层节次选择、分组宽表与局部详情已实现，审查发现的教室epoch加载问题已修。492项Flutter门禁、手机/平板各14业务场景及110/122图复核通过，P4-B领域批次已勾选；共享手机筛选折叠UX-13仍待P4-A补齐，最终多设备不据此通过；macOS新界面手工验收仍受锁屏阻塞。
