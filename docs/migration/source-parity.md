...
| Signin、Ygdk、LibBook | 课堂签到今日查询；阳光打卡只读查询；图书馆座位只读查询；直接写操作表 | Signin 的“全部/未签到/已签到”仅按冻结 `signStatus` 0/1 本地派生；其余 typed prepare、一次性 intent、commit 后读取核对 |
