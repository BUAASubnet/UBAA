...
|---|---|---|
| Direct | Real verification passed on 2026-08-17 | Exit 0; profile parsed; `auth status` passed in 79 ms; name prefix `李`; school ID suffix `04` |
| WebVPN | Real verification passed on 2026-08-17 | Exit 0; profile parsed; `auth status` passed in 161 ms; name prefix `李`; school ID suffix `04` |
