        ...
        authenticatedRoute {
            get("/terms") {
                ...
                try {
                    ...
                    call.respond(
                        ...
                        ErrorResponse(ErrorDetails("upstream_error", e.message ?: "Failed to fetch schedule data."))
                    )
                } catch (e: Exception) {
            ...
            get("/week") {
                ...
                if (week == null || week <= 0) {
                    call.respond(
                        HttpStatusCode.BadRequest,
                        ErrorResponse(ErrorDetails("invalid_request", "week parameter must be a positive integer"))
                    )
                    return@get
                }
                ...
                try {
                    ...
                    call.application.environment.log.error("Unexpected error while fetching weekly schedule.", e)
                    call.respond(
                        HttpStatusCode.InternalServerError,
                        ErrorResponse(ErrorDetails("internal_server_error", "An unexpected server error occurred."))
                    )
            ...
            get("/today") {
                ...
                try {
                    ...
                    call.application.environment.log.error("Unexpected error while fetching today's schedule.", e)
                    call.respond(
                        HttpStatusCode.InternalServerError,
                        ErrorResponse(ErrorDetails("internal_server_error", "An unexpected server error occurred."))
                    )
