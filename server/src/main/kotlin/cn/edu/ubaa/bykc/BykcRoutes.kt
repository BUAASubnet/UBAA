...
fun Route.bykcRouting() {
        ...
        route("/api/v1/bykc") {
                authenticatedRoute {
                        ...
                        /** GET /api/v1/bykc/profile 获取博雅课程用户信息 */
                        get("/profile") {
                        ...
                        get("/courses") {
                                ...
                                val size =
                                        call.request.queryParameters["size"]?.toIntOrNull() ?: 200
                                val includeAll =
                                        call.request.queryParameters["all"]?.toBoolean() ?: false
                        ...
                        get("/courses/{courseId}") {
                                ...
                                try {
                                        val courseDetail =
                                                bykcService.getCourseDetail(username, courseId)
