        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    course.courseSerialNo?.let { serialNo ->
                        CourseInfoRow("课程序号", serialNo)
                    }
                    
                    course.credit?.let { credit ->
                        CourseInfoRow("学分", credit)
                    }
                    
                    course.placeName?.let { place ->
                        CourseInfoRow("上课地点", place)
                    }
                    ...
                    if (course.beginSection != null && course.endSection != null) {
                        val sectionText = if (course.beginSection == course.endSection) {
            ...
            if (!course.weeksAndTeachers.isNullOrBlank() || !course.teachingTarget.isNullOrBlank()) {
                Card(
                    modifier = Modifier.fillMaxWidth()
                ) {
                    Column(
                        ...
                        course.teachingTarget?.let { teachingTarget ->
                            CourseInfoRow("教学对象", teachingTarget)
                        }
                    }
                }
            }
