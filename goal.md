...
状态：执行中（2026-09-09）。旧版三导航、按需查询和实际路线外壳已提交；O3-A/B/C、图书馆D1/D1b及研讨室D2/D2b已分批提交并取得局部原生证据。当前D3博雅已实现公开投影、旧卡片/独立详情/统计，588项Flutter门禁与三端38场景通过，生产五类只读两路线通过（已选0条，真实已选详情未执行）；D4阳光旧概要/记录与按需查询、600项门禁、三端28场景及生产双路线只读已通过；D5首页六来源已实现并取得617项门禁、三端与生产双路线8来源只读证据；学业旧细节、P5完整写入及P6–P7仍未完成。历史候选证据不替代最终多端验收。
